  ...
  return (function(e) {
          ...
          return s(t, e), (t.prototype.componentDidMount = function() {
            ...
            var n = l.default.Children.map(this.state.children, function(t, n) {
              if (t) {
                ...
                var p = e.props.geoService.fromLatLngToContainerPixel(o),
                  c = void 0 !== t.key && null !== t.key ? t.key : n;
                return (e.dimensionsCache_[c] = a(
                  { x: p.x, y: p.y },
                  o
    ...
    function(e, t) {
      ...
      function n() {
        ...
        try {
          ...
          window.addEventListener('test', t, t), window.removeEventListener(
            'test',
            t,
            t
          );
      ...
      function o(e, t, o, r) {
        e.addEventListener(t, o, n() ? { capture: r, passive: !0 } : r);
      }
    ...
    function(e, t, n) {
      ...
      var u = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
        ...
        oe = 3,
        re = 32,
        ie = void 0 !== _.default.createPortal,
        se = ie
          ? _.default.createPortal
          : _.default.unstable_renderSubtreeIntoContainer,
        ae = function(e) {
          return (0, G.default)(e) ? e : { lat: e[0], lng: e[1] };
        },
        ue = function(e, t) {
          return t < e ? e : t;
        },
        ...
        pe = (function(e) {
            ...
            if (
              ((o._getMinZoom = function() {
                if (
                  ...
                  var e = Math.ceil(o.geoService_.getWidth() / ee) + 2,
                    t = Math.ceil(o.geoService_.getHeight() / ee) + 2,
                    n = Math.max(e, t);
                  return Math.ceil((0, N.default)(n));
                }
                return oe;
              }), (o._computeMinZoom = function(e) {
                return (0, Z.default)(e) ? o._getMinZoom() : e;
              ...
              }), (o._renderPortal = function() {
                return c.default.createElement(C.default, {
                  experimental: o.props.experimental,
                  onChildClick: o._onChildClick,
                  onChildMouseDown: o._onChildMouseDown,
                  onChildMouseEnter: o._onChildMouseEnter,
                  onChildMouseLeave: o._onChildMouseLeave,
                  geoService: o.geoService_,
                  insideMapPanes: !0,
                  distanceToMouse: o.props.distanceToMouse,
                  getHoverDistance: o._getHoverDistance,
                  dispatcher: o.markersDispatcher_,
                });
              }), (o._initMap = function() {
                if (!o.initialized_) {
                  o.initialized_ = !0;
                  var e = ae(o.props.center || o.props.defaultCenter);
                    ...
                    .then(function(e) {
                      if (o.mounted_) {
                        ...
                        o.props.heatmap.positions &&
                          (Object.assign(o, {
                            heatmap: (0, L.generateHeatmap)(e, o.props.heatmap),
                          }), (0, L.optionsHeatmap)(
                            o.heatmap,
                            o.props.heatmap
                          ));
                        var r = (0, E.default)(e, G.default),
                          i = 'function' == typeof o.props.options
                            ? o.props.options(r)
                            : o.props.options,
                          s = a(r),
                          p = !(0, Z.default)(o.props.draggable) && {
                            draggable: o.props.draggable,
                          },
                          c = o._computeMinZoom(i.minZoom);
                        o.minZoom_ = c;
                        var f = l({}, s, { minZoom: c }, i, n);
                        o.defaultDraggableOption_ = (0, Z.default)(f.draggable)
                          ? o.defaultDraggableOption_
                          : f.draggable;
                        var d = l({}, f, p);
                        d.minZoom = ue(d.minZoom, c);
                        var h = new e.Map(
                          _.default.findDOMNode(o.googleMapDom_),
                          d
                        );
                        (o.map_ = h), (o.maps_ = e), o._setLayers(
                          o.props.layerTypes
                        );
                        var m = e.version.match(/^3\.(\d+)\./),
                          ...
                          y = Object.assign(new e.OverlayView(), {
                            onAdd: function() {
                              ...
                              if (
                                ((o.style.backgroundColor = 'transparent'), (o.style.position = 'absolute'), (o.style.left = '0px'), (o.style.top = '0px'), (o.style.width = t), (o.style.height = n), v.props.overlayViewDivStyle)
                              ) {
                              ...
                              var i = this.getPanes();
                              i.overlayMouseTarget.appendChild(
                                o
                                ...
                                : se(v, v._renderPortal(), o, function() {
                            ...
                            onRemove: function() {
                              ...
                              e &&
                                !ie &&
                                _.default.unmountComponentAtNode(
                                  e
                            ...
                            draw: function() {
                              if (
                                ...
                                var t = v.geoService_.fromContainerPixelToLatLng(
                                  v.mouse_
                                );
                                (v.mouse_.lat = t.lat), (v.mouse_.lng = t.lng);
                              }
                              v._onChildMouseMove(), v.markersDispatcher_ &&
                        ...
                        (o.overlay_ = y), y.setMap(
                          ...
                          o.heatmap.setMap(h), o.props.onTilesLoaded &&
                          ...
                          function() {
                            if (
                              ...
                              (v.zoomAnimationInProgress_ ||
                                ((v.zoomAnimationInProgress_ = !0), v._onZoomAnimationStart(
                                  h.zoom
                                )), g < re)
                            ) {
                              var t = 300;
                          ...
                          if (o.resetSizeOnIdle_) {
                            ...
                            t !== o.minZoom_ &&
                              ((o.minZoom_ = t), h.setOptions({
                                minZoom: t,
                              })), (o.resetSizeOnIdle_ = !1);
                          }
                          v.zoomAnimationInProgress_ &&
                            ((v.zoomAnimationInProgress_ = !1), v._onZoomAnimationEnd(
                              h.zoom
                            )), v.updateCounter_++, v._onBoundsChanged(h, e), (v.dragTime_ = 0), v.markersDispatcher_ && v.markersDispatcher_.emit('kON_CHANGE');
                ...
                return o.props.onTilesLoaded && o.props.onTilesLoaded();
              }), (o._onChildClick = function() {
                ...
                (o.childMouseDownArgs_ = [e, t]), o.props.onChildMouseDown &&
                  o.props.onChildMouseDown(e, t, l({}, o.mouse_));
                ...
                if (o.childMouseDownArgs_) {
                  if (o.props.onChildMouseUp) {
                    ...
                    (e = o.props).onChildMouseUp.apply(
                      e,
                      o.childMouseDownArgs_.concat([l({}, o.mouse_)])
                    );
                  }
                ...
                if (o.mouseInMap_) {
                  ...
                  var s = o.geoService_.fromContainerPixelToLatLng(o.mouse_);
                ...
                return o.props.onClick &&
                  ...
                  new Date().getTime() - o.childMouseUpTime_ > ne &&
                  0 === o.dragTime_ &&
                ...
                if (
                  ...
                  if (!(0, q.default)(s, o.prevBounds_, Q) && n !== !1) {
                    var u = o.geoService_.getBounds(o.props.margin);
                    o.props.onBoundsChange &&
                      o.props.onBoundsChange(
                        o.centerIsObject_ ? l({}, a) : [a.lat, a.lng],
                        i,
                        s,
                        u
                      ), o.props.onChange &&
                ...
                o
              )), (o.geoService_ = new T.default(
                ee
              )), (o.centerIsObject_ = (0, G.default)(
                o.props.center
              )), (o.minZoom_ = oe), (o.defaultDraggableOption_ = !0), (o.zoomControlClickTime_ = 0), (o.childMouseDownArgs_ = null), (o.childMouseUpTime_ = 0), (o.googleMapDom_ = null), o._isCenterDefined(
                o.props.center || o.props.defaultCenter
              ))
            ) {
              var s = ae(o.props.center || o.props.defaultCenter);
          ...
          return s(t, e), (t.prototype.componentDidMount = function() {
            var e = this;
            (this.mounted_ = !0), (0, J.default)(
              window,
              'resize',
              this._onWindowResize,
              !1
            ), (0, J.default)(window, 'keydown', this._onKeyDownCapture, !0);
            var t = _.default.findDOMNode(this.googleMapDom_);
            t &&
              (0, J.default)(
                t,
                'mousedown',
            ...
            if (
              ...
              var o = this;
              Y.default.addResizeListener(t, o._mapDomResizeCallback);
            }
            ...
            if (
              ...
              if (this._isCenterDefined(e.center)) {
                var o = ae(e.center),
                  r = this._isCenterDefined(this.props.center)
                    ? ae(this.props.center)
                    : null;
                (!r || Math.abs(o.lat - r.lat) + Math.abs(o.lng - r.lng) > Q) &&
                  Math.abs(o.lat - n.lat) + Math.abs(o.lng - n.lng) > Q &&
                  this.map_.panTo({ lat: o.lat, lng: o.lng });
              }
              if (
                ((0, Z.default)(e.zoom) ||
                  (Math.abs(e.zoom - this.props.zoom) > 0 &&
                    this.map_.setZoom(e.zoom)), !(0, Z.default)(
                  ...
                  : (0, K.default)(this.props.draggable, e.draggable) ||
                      ...
                      }), !(0, Z.default)(e.options) &&
                  !(0, K.default)(this.props.options, e.options))
              ) {
                var i = (0, E.default)(this.maps_, G.default),
              ...
              (0, K.default)(e.layerTypes, this.props.layerTypes) ||
                ...
                }), this._setLayers(e.layerTypes)), this.heatmap &&
                !(0, K.default)(
                  e.heatmap.positions,
            ...
            this.markersDispatcher_.emit('kON_CHANGE'), (0, K.default)(
              this.props.hoverDistance,
              e.hoverDistance
            ) || this.markersDispatcher_.emit('kON_MOUSE_POSITION_CHANGE');
          }), (t.prototype.componentWillUnmount = function() {
            this.mounted_ = !1;
            var e = _.default.findDOMNode(this.googleMapDom_);
            e &&
              ...
              Y.default.removeResizeListener(
                e,
      ...
      (pe.propTypes = {
        ...
        bootstrapURLKeys: d.default.any,
        defaultCenter: d.default.oneOfType([
          d.default.array,
          d.default.shape({ lat: d.default.number, lng: d.default.number }),
        ]),
        center: d.default.oneOfType([
          d.default.array,
          d.default.shape({ lat: d.default.number, lng: d.default.number }),
        ]),
        defaultZoom: d.default.number,
        zoom: d.default.number,
        onBoundsChange: d.default.func,
        onChange: d.default.func,
        onClick: d.default.func,
        onChildClick: d.default.func,
        onChildMouseDown: d.default.func,
        onChildMouseUp: d.default.func,
        onChildMouseMove: d.default.func,
        onChildMouseEnter: d.default.func,
        onChildMouseLeave: d.default.func,
        onZoomAnimationStart: d.default.func,
        onZoomAnimationEnd: d.default.func,
        onDrag: d.default.func,
        onDragEnd: d.default.func,
        onMapTypeIdChange: d.default.func,
        onTilesLoaded: d.default.func,
        options: d.default.any,
        distanceToMouse: d.default.func,
        hoverDistance: d.default.number,
        debounced: d.default.bool,
        margin: d.default.array,
        googleMapLoader: d.default.any,
        onGoogleApiLoaded: d.default.func,
        yesIWantToUseGoogleMapApiInternals: d.default.bool,
        draggable: d.default.bool,
        style: d.default.any,
        resetBoundsOnResize: d.default.bool,
        layerTypes: d.default.arrayOf(d.default.string),
        shouldUnregisterMapOnUnmount: d.default.bool,
      }), (pe.defaultProps = {
      ...
      }), (pe.googleMapLoader = O.default), (t.default = pe);
    },
    function(e, t, n) {
      'use strict';
      function o(e) {
        ...
        return s || (s = n(30)), e
          ? a
              ...
              : ((a = new Promise(function(n, o) {
                  ...
                  var a = Object.keys(e).reduce(
                    function(t, n) {
                      return t + '&' + n + '=' + e[n];
                    },
                    ''
                  ),
                    u = t ? '&libraries=visualization' : '';
                  s('' + r + i + a + u, function() {
    ...
    function(e, t, n) {
      ...
      r = a ? window : 'undefined' != typeof self ? self : void 0;
      var u = 'undefined' != typeof document && document.attachEvent, l = !1;
      if (a && !u) {
        var p = (function() {
          ...
          h = function(e) {
            ...
            f(this), this.__resizeRAF__ &&
              c(this.__resizeRAF__), (this.__resizeRAF__ = p(function() {
              d(t) &&
        ...
        if (a) {
          ...
          if ((void 0 !== w.style.animationName && (_ = !0), _ === !1))
            for (var b = 0; b < y.length; b++)
              if (void 0 !== w.style[y[b] + 'AnimationName']) {
                (C = y[b]), (m = C + 'Animation'), (g = '-' +
                  C.toLowerCase() +
                  '-'), (v = M[b]), (_ = !0);
                break;
              }
          ...
          (e = e.parentNode), u
            ...
            : (e.__resizeTriggers__ ||
                ('static' == getComputedStyle(e).position &&
                  (e.style.position = 'relative'), S(), (e.__resizeLast__ = {
                  ...
                  e.__resizeTriggers__
                ), f(e), (0, s.default)(e, 'scroll', h, !0), v &&
                  e.__resizeTriggers__.addEventListener(v, function(t) {
                    t.animationName == L && f(e);
      ...
      e.exports = { addResizeListener: T, removeResizeListener: z };
    },
    function(e, t, n) {
      'use strict';
      function o(e) {
      ...
      var i = Object.assign ||
        ...
        f = (function() {
          ...
          return (e.prototype.setView = function(e, t, n) {
            ...
            var n = i({}, e);
            (n.x -= this.transform_.width / 2), (n.y -= this.transform_.height /
              2);
            var o = this.transform_.pointLocation(a.default.convert(n));
            ...
            if (this.getWidth() - o - i > 0 && this.getHeight() - n - r > 0) {
              var s = this.transform_.pointLocation(
                ...
                l = [s.lat, s.lng, u.lat, u.lng, u.lat, s.lng, s.lat, u.lng];
              return t &&
                (l = l.map(function(e) {
